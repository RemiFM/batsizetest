...
cell_HE = BatteryCell(
    ...
    voltage     = 3.67,
    dis_rate    = scols[0].number_input("Discharge C-rate _(A/Ah)_", value=1.0, min_value=0.0, step=0.25),
    chg_rate    = scols[1].number_input("Charge C-rate _(A/Ah)_", value=1.0, min_value=0.0, step=0.25),
    resistance  = scols[0].number_input("Internal Resistance _(mΩ)_", value=1.5, min_value=0.0, step=0.1)/1000,
    weight      = scols[1].number_input("Cell Weight _(g)_", value=0.885*1000, min_value=0.0, step=0.1),
...
cell_HP = BatteryCell(
    ...
    voltage     = 2.3,
    dis_rate    = scols[0].number_input("Discharge C-rate _(A/Ah)_", value=4.0, min_value=0.0, step=0.25),
    chg_rate    = scols[1].number_input("Charge C-rate _(A/Ah)_", value=4.0, min_value=0.0, step=0.25),
    resistance  = scols[0].number_input("Internal Resistance _(mΩ)_", value=1.1, min_value=0.0, step=0.1)/1000,
    weight      = scols[1].number_input("Cell Weight _(g)_", value=0.55*1000, min_value=0.0, step=0.1),
